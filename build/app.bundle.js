    ...
    _createClass(App, [{
        ...
        value: function render() {
            return _react2.default.createElement(
                ...
                _react2.default.createElement(_Title2.default, { counterFromParent: this.state.data.length }),
                _react2.default.createElement(_TodoList.TodoList, { listFromParent: this.state.data, remove: this.removeTodo.bind(this) })
            );
        }
    }]);
	...
	_createClass(Title, [{
		...
		value: function render() {
			return _react2.default.createElement(
				...
				_react2.default.createElement(
					'h3',
					{ className: _Title2.default.TodoTitle2 },
					'Ilo\u015B\u0107 zada\u0144 dodanych do listy to: '
				),
				_react2.default.createElement(
					'h1',
					{ className: _Title2.default.counter },
					this.props.counterFromParent
				)
			);
		}
	}]);
...
// module
exports.push([module.i, "._4MysLSH9RhDYAa_kXrEnt {\r\n    color: red;\r\n    text-align: center;\r\n}\r\n._3OyZgX8MrTspxDu0PIb-9j {\r\n    color: green;\r\n    text-align: center;\r\n}\r\n._3Dd2HhBB8fnCx-l1DwOA6y {\r\n    font-size: 40px;\r\n    font-style: bold;\r\n    text-align: center;\r\n}", ""]);

// exports
exports.locals = {
	"TodoTitle": "_4MysLSH9RhDYAa_kXrEnt",
	"TodoTitle2": "_3OyZgX8MrTspxDu0PIb-9j",
	"counter": "_3Dd2HhBB8fnCx-l1DwOA6y"
};
...
var TodoList = exports.TodoList = function TodoList(props) {
  return _react2.default.createElement(
    'div',
    null,
    props.listFromParent.map(function (item, value) {
      return _react2.default.createElement(
        'li',
        { className: _TodoList2.default.TodoList, key: value, onClick: props.remove },
        item.text
      );
    })
  );
